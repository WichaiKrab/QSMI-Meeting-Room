          ...
          <div className="py-4 text-center space-y-4 animate-fade-in">
            ...
            <div className="p-4 bg-amber-50 border border-amber-200 rounded-2xl text-left text-xs space-y-2 max-w-sm mx-auto">
              ...
              <p className="text-[11px] text-amber-800 pt-1">
                ระบบได้ส่งอีเมลตอบรับคำขอไปยังอีเมลของคุณแล้ว และส่งแจ้งเตือนไปยังผู้ดูแลระบบสูงสุด (Super Admin) เพื่อพิจารณาอนุมัติ เมื่อได้รับการอนุมัติเรียบร้อย ระบบจะส่งอีเมลตอบรับยืนยันผลการอนุมัติให้อีกครั้ง เพื่อให้คุณเข้าสู่ระบบได้ทันที
              </p>
            </div>
